...
Mainwin::Mainwin() : shelter{new Shelter{"Mavs Animal Shelter"}} {
    ...
    Gtk::MenuItem *menuitem_open_file = Gtk::manage(new Gtk::MenuItem("Open _File", true));
    menuitem_open_file->signal_activate().connect([this] {this->on_open_file_click();});
...
void Mainwin::on_open_file_click() {
    Gtk::FileChooserDialog dialog("Please choose a file",
          Gtk::FileChooserAction::FILE_CHOOSER_ACTION_OPEN);
    dialog.set_transient_for(*this);

    auto filter_mass = Gtk::FileFilter::create();
    filter_mass->set_name("MASS files");
    filter_mass->add_pattern("*.mass");
